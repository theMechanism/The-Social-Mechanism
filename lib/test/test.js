...
// 	})
// })
describe('socialupdate library', function() {
	describe('#init', function() {
		it('should open the db without any errors', function(done) {
			socialUpdate.init('social_yotd', done);
		});
	});
